...
public class TrainFareEnquiryInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "http://api.railwayapi.com/fare/train/"+trainNumber+"/source/"+fromCode+"/dest/"+toCode+"/age/"+age+"/quota/"+quota+"/doj/"+doj+"/apikey/rigng1122/";
